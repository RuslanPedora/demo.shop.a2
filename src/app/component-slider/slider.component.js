...
var point_1 = require('mycore/point');
var SliderComponent = (function () {
    ...
    SliderComponent.prototype.viewListInit = function () {
        ...
        for (i in this.itemList) {
            ...
            this.viewList.push(new point_1.Point(this.itemList[i], x, y, z, xView, yView, imageWidth, imageWidth / this.imageWidth));
        }
    ...
    SliderComponent = __decorate([
        ...
        __metadata('design:paramtypes', [router_1.Router, (typeof (_a = typeof data_service_1.DataService !== 'undefined' && data_service_1.DataService) === 'function' && _a) || Object])
    ], SliderComponent);
